...
type ChartXAxisProps = {
  axis?: "x"
} & Omit<React.ComponentProps<typeof RechartsPrimitive.XAxis>, "ref">

type ChartYAxisProps = {
  axis: "y"
} & Omit<React.ComponentProps<typeof RechartsPrimitive.YAxis>, "ref">

type ChartAxisProps = ChartXAxisProps | ChartYAxisProps
