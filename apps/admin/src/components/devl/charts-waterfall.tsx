    ...
    <div className="bg-background px-10 py-10 min-h-svh">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="bg-background/40 mt-6 p-6 border border-border/60 rounded-xl">
          <div className="flex items-center gap-3 mb-3 font-mono text-[10px] text-muted-foreground uppercase tracking-[0.25em]">
            <span className="flex items-center gap-1.5">
              <span className="bg-foreground/70 rounded-sm size-2.5" />
              start / end
            </span>
            <span className="flex items-center gap-1.5">
              <span className="bg-emerald-500 rounded-sm size-2.5" />
              addition
            </span>
            <span className="flex items-center gap-1.5">
              <span className="bg-rose-500 rounded-sm size-2.5" />
              loss
            </span>
