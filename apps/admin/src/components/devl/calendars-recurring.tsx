...
export function CalendarsRecurringShowcasePage() {
  ...
  return (
    <div className="bg-muted/30 px-6 py-8 min-h-svh">
      <div className="space-y-4 mx-auto max-w-5xl">
        ...
        <div className="bg-background shadow-sm border border-border rounded-xl overflow-hidden">
          ...
          />
          <div className="grid grid-cols-1 lg:grid-cols-2 lg:divide-x divide-y lg:divide-y-0 divide-border/60">
          ...
          <div className="flex justify-between items-center bg-muted/20 px-5 py-3 border-border/60 border-t">
            <span className="font-mono text-[11px] text-muted-foreground">
...
function Templates({
  ...
  return (
    <div className="flex items-center gap-2 bg-background px-5 py-3 border-border/60 border-b overflow-x-auto">
      <span className="inline-flex items-center gap-1.5 font-mono text-[10px] text-muted-foreground uppercase tracking-[0.2em] shrink-0">
...
function Editor({
  ...
  return (
    <div className="space-y-5 px-5 py-5">
      <Row label="FREQ">
        <div className="flex items-center bg-background p-0.5 border border-border/70 rounded-md">
          {FREQS.map((f) => (
            <button
              key={f}
              type="button"
          ...
          <EndOption
            ...
            trailing={
              rule.end.type === "until" ? (
                <button
                  type="button"
                  className="inline-flex items-center gap-2 bg-background ml-auto px-2 py-1 border border-border/70 rounded-md font-mono text-[11px]"
                >
                  <CalendarIcon className="opacity-60 size-3" />
...
function Row({
  ...
  return (
    <div className="items-start gap-3 grid grid-cols-[110px_1fr]">
  ...
  return (
    <div className="space-y-5 bg-muted/10 px-5 py-5">
      <div>
        ...
        <div className="bg-background mt-1.5 px-3 py-2.5 border border-border/60 rounded-lg overflow-x-auto font-mono text-[12px] leading-relaxed">
      ...
      <div>
        ...
        <ul className="bg-background mt-2 border border-border/60 rounded-lg divide-y divide-border/40 overflow-hidden">
          {occurrences.length === 0 ? (
            ...
            occurrences.map((d, i) => {
              ...
              return (
                <li
                  key={i}
                  className="flex justify-between items-baseline px-3 py-1.5 font-mono text-[12px]"
                >
...
function MiniCalendar({
  ...
  return (
    <div className="bg-background p-3 border border-border/60 rounded-lg">
      <div className="flex justify-between items-center mb-2">
        <button
          type="button"
          onClick={() => setOffset(offset - 1)}
          className="place-items-center grid hover:bg-muted rounded size-6 text-muted-foreground hover:text-foreground"
        >
      ...
      <div className="gap-y-1 grid grid-cols-7 text-center">
        ...
        {cells.map((c, i) => {
          ...
          return (
            <div key={i} className="place-items-center grid">
              <div
                className={
      ...
      <div className="flex items-center gap-3 mt-3 pt-2 border-border/60 border-t font-mono text-[10px] text-muted-foreground">
        <span className="inline-flex items-center gap-1.5">
          <span className="bg-foreground rounded-sm size-2" />
          Occurrence
        </span>
        <span className="inline-flex items-center gap-1.5">
          <span className="border border-foreground/40 rounded-sm size-2" />
          Today
        </span>
