...
export function CardTaskShowcasePage() {
  return (
    <div className="bg-background px-6 py-12 min-h-svh">
        ...
        {task.labels.length ? (
          <div className="flex flex-wrap items-center gap-1.5 mt-3">
            {task.labels.map((l) => (
              <span
                key={l.name}
                className="inline-flex items-center gap-1 bg-background px-2 py-0.5 border border-border rounded-full text-[11px]"
              >
        ...
        <div className="flex justify-between items-center mt-3">
          <div className="flex items-center -space-x-1.5">
            {task.assignees.map((a) => (
              <Avatar
                key={a}
                className="bg-foreground border-2 border-background size-5"
              >
