          ...
          <div className="flex items-center gap-3">
            {SERIES.map((s) => (
              <button
                key={s.key}
                type="button"
                className="inline-flex items-center gap-1.5 bg-background/40 px-2 py-1 border border-border/60 rounded-md text-xs"
              >
                <span
            ...
            <div className="flex items-center gap-1 ml-auto font-mono text-[10px] text-muted-foreground uppercase tracking-[0.25em]">
              <button
                type="button"
                className="hover:bg-foreground/[0.05] px-2 py-1 rounded"
              >
                7d
              </button>
              <button
                type="button"
                className="bg-foreground/[0.08] px-2 py-1 rounded"
              >
                30d
              </button>
              <button
