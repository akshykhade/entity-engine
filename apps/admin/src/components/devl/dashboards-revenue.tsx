  ...
  return (
    <div className="bg-background px-10 py-10 min-h-svh">
      <div className="space-y-6 mx-auto max-w-6xl">
        ...
        <div className="gap-px grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] bg-border/60 border border-border/60 rounded-2xl overflow-hidden">
            ...
            <div className="flex justify-between items-baseline">
              <div>
                ...
                <div className="flex items-baseline gap-3 mt-2">
                  <span className="font-heading tabular-nums text-5xl">
                    ${current!.toFixed(1)}k
                  </span>
                  <Delta value={growth} />
                </div>
          ...
          <div className="bg-background p-6">
            ...
            <div className="mt-5">
              ...
              <div className="flex items-baseline gap-2 mt-2">
                <span className="font-heading tabular-nums text-3xl">112%</span>
                <Delta value={2.1} />
              </div>
              <div className="bg-foreground/[0.06] mt-3 rounded-full h-2 overflow-hidden">
                <div
                  className="bg-emerald-500 h-full"
                  style={{ width: "112%", maxWidth: "100%" }}
                />
              </div>
              <div className="flex justify-between mt-1.5 font-mono tabular-nums text-[10px] text-muted-foreground">
                <span>0%</span>
                <span>100%</span>
                <span>120%</span>
              </div>
        ...
        <div className="gap-px grid grid-cols-1 lg:grid-cols-2 bg-border/60 border border-border/60 rounded-2xl overflow-hidden">
          <div className="bg-background p-6">
            <div className="font-mono text-[10px] text-muted-foreground uppercase tracking-[0.3em]">
              By plan
            </div>
              ...
              {PLANS.map((p) => {
                ...
                return (
                  <div key={p.name}>
                    ...
                    <div className="bg-foreground/[0.04] mt-1.5 rounded-full h-2 overflow-hidden">
                      <div
          ...
          <div className="bg-background p-6">
            <div className="flex justify-between items-baseline">
              ...
              <a
                href="#"
                className="font-mono text-[10px] text-muted-foreground hover:text-foreground uppercase tracking-[0.25em]"
              >
                view all →
              </a>
            </div>
