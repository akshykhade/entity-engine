  ...
  return (
    <div className="bg-background px-10 py-10 min-h-svh">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="inline-flex items-center gap-1 bg-background/40 mt-5 p-0.5 border border-border/60 rounded-md font-mono text-[10px] uppercase tracking-[0.2em]">
        ...
        <div className="bg-background/40 mt-4 border border-border/60 rounded-xl overflow-hidden">
          <div className="grid grid-cols-[220px_1fr] bg-background border-border/40 border-b">
            <div className="px-4 py-2 border-border/40 border-r font-mono text-[10px] text-muted-foreground uppercase tracking-[0.25em]">
              Member · {team.length}
            </div>
          ...
          {/* Holiday strip */}
          <div className="grid grid-cols-[220px_1fr] bg-amber-500/[0.04] border-border/40 border-b">
            <div className="flex items-center gap-2 px-4 py-2 border-border/40 border-r font-mono text-[10px] text-amber-700 dark:text-amber-400 uppercase tracking-[0.25em]">
              Public holidays
            </div>
          ...
          {segmentsByMember.length === 0 ? (
            <div className="px-6 py-12 font-mono text-[10px] text-muted-foreground text-center uppercase tracking-[0.25em]">
              No teammates yet.
            </div>
          ) : (
            segmentsByMember.map(({ member: m, segments }) => (
              ...
              >
                <div className="flex items-center gap-2.5 px-4 py-3 border-border/40 border-r">
                  <Avatar
                    className={
                      "size-7 " +
                      (((m as Member & { tone?: string }).tone) ?? autoTone(m.name))
                  ...
                  <button
                    ...
                    className="hover:bg-foreground/[0.05] opacity-0 group-hover:opacity-100 p-1 rounded-md text-muted-foreground/40 hover:text-destructive transition-all"
                  >
        ...
        <div className="flex items-center gap-3 mt-4 font-mono text-[10px] text-muted-foreground uppercase tracking-[0.2em]">
...
function AddMemberPopover({
  ...
  return (
    <Popover>
      ...
      <PopoverPopup className="!p-0 !w-72" side="bottom" align="end">
