...
export function CardPaymentMethodShowcasePage() {
  ...
  return (
    <div className="bg-background px-6 py-16 min-h-svh">
      <div className="mx-auto max-w-md">
        ...
        <Card>
          ...
          <CardPanel className="pt-2">
            ...
            <ul className="flex flex-col mt-3 divide-y divide-border">
              {METHODS.map((m) => (
                <li
                  key={m.id}
          ...
          <CardFooter className="flex-col items-stretch gap-2 border-t">
            ...
            <p className="inline-flex justify-center items-center gap-1.5 text-muted-foreground text-xs">
...
function CreditCardArt({
  ...
  return (
    <div
      className="relative shadow-md rounded-xl w-full h-44 overflow-hidden text-white"
      ...
      <div className="relative flex flex-col justify-between p-5 h-full">
        <div className="flex justify-between items-start">
          <div className="flex flex-col gap-1">
            <div className="opacity-80 font-mono text-[10px] uppercase tracking-[0.3em]">
              Orbit · primary
            </div>
            <div className="bg-amber-300/80 shadow-inner rounded-md size-7" />
          </div>
        ...
        <div>
          ...
          <div className="flex justify-between items-end opacity-90 mt-2 font-mono text-[10px] uppercase tracking-widest">
            <div>
